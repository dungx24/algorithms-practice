...
print("Average age: ",np.average(passengers[:, 3]))
print("The oldest one is at seat: ", passengers[passengers[:,3] == max(passengers[:, 3])][:,0])
print("The youngest one is at seat: ", passengers[passengers[:,3] == min(passengers[:, 3])][:,0])
